...
SELECT * FROM book.tb_book;CREATE TABLE `tb_borrowlog` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tb_user` (
  ...
  `password` varchar(40) NOT NULL DEFAULT '0' COMMENT '登录密码',
  `userrole` varchar(40) NOT NULL DEFAULT '0' COMMENT '用户角色',
  PRIMARY KEY (`id`)
